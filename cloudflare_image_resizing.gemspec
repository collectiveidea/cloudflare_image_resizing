...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Easily resize images using Cloudflare's image resizing service."
  spec.description = "Easily resize images using Cloudflare's image resizing service."
  spec.license = "MIT"
